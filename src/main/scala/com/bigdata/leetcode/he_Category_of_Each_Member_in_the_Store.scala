...
class he_Category_of_Each_Member_in_the_Store {
...
object he_Category_of_Each_Member_in_the_Store {
  def main(args: Array[String]) {
    val he_Category_of_Each_Member_in_the_Store = new he_Category_of_Each_Member_in_the_Store()

    def apply(): he_Category_of_Each_Member_in_the_Store = he_Category_of_Each_Member_in_the_Store
